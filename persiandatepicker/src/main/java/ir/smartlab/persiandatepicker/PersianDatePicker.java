...
public class PersianDatePicker extends LinearLayout {
    ...
    public PersianDatePicker(Context context, AttributeSet attrs, int defStyle) {
       ...
       // descriptionTextView = (TextView) view.findViewById(R.id.descriptionTextView);
        ...
        String timezone = a.getString(R.styleable.PersianDatePicker_timezone);
    ...
    private final NumberPicker.OnValueChangeListener dateChangeListener = new NumberPicker.OnValueChangeListener() {
    ...
    private void setDisplayDate (Date displayDate) {
